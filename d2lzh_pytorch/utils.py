...
def data_iter(batch_size, features, labels):
    ...
    random.shuffle(indices)  # 样本的读取顺序是随机的  random.shuffle将序列进行随机排列
    for i in range(0, num_examples, batch_size):  # range(start, stop, step) step:步长
